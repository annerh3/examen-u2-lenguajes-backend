...
namespace ProyectoExamenU2.Migrations.PrincipalDatabase
{
    /// <inheritdoc />
    public partial class InitialMigrationPrincipalDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_account_catalog_account_catalog_ParentAccountId",
                        column: x => x.ParentAccountId,
                        principalSchema: "dbo",
                        principalTable: "account_catalog",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_account_catalog_users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalSchema: "security",
                        principalTable: "users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_account_catalog_users_UpdatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_journal_entry_users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalSchema: "security",
                        principalTable: "users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_journal_entry_users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalSchema: "security",
                        principalTable: "users",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_balances_users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalSchema: "security",
                        principalTable: "users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_balances_users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalSchema: "security",
                        principalTable: "users",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_journal_entry_detail_users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalSchema: "security",
                        principalTable: "users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_journal_entry_detail_users_UpdatedByUserId",
                        column: x => x.UpdatedByUserId,
                        principalSchema: "security",
                        principalTable: "users",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_account_catalog_CreatedByUserId",
                schema: "dbo",
                table: "account_catalog",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_account_catalog_ParentAccountId",
                schema: "dbo",
                table: "account_catalog",
                column: "ParentAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_account_catalog_UpdatedByUserId",
                schema: "dbo",
                table: "account_catalog",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_balances_CreatedByUserId",
                schema: "dbo",
                table: "balances",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_balances_UpdatedByUserId",
                schema: "dbo",
                table: "balances",
                column: "UpdatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_journal_entry_CreatedByUserId",
                schema: "dbo",
                table: "journal_entry",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_journal_entry_UpdatedByUserId",
                schema: "dbo",
                table: "journal_entry",
                column: "UpdatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_journal_entry_detail_CreatedByUserId",
                schema: "dbo",
                table: "journal_entry_detail",
                column: "CreatedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_journal_entry_detail_UpdatedByUserId",
                schema: "dbo",
                table: "journal_entry_detail",
                column: "UpdatedByUserId");
